...
<body>
  ...
  <article>
    <div class="khung">
      <div class="hinh">
        <img src="../image/thucan2.jpg" alt="anhsp">
      </div>
      <br>
    </div>
    <div class="thongtin">
      <h3>Soup lon vị gà cho mèo trưởng thành</h3>
      <span> Giá: 50.000 vnđ</span> <br>
      <span>Lượt Xem : 323</span> <i class="ri-eye-line"></i>

      <br>
      <!-- <input type="button" value="Thêm Vào Giỏ Hàng" onclick="addCart(this, 6, 'Soup lon vị gà cho mèo trưởng thành', 100000, 'image/thucan2.jpg', 1)">
