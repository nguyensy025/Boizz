...
<body>
  ...
  <article>
    <div class="khung">
      <div class="hinh">
        <img src="../image/thucan4.jpg" alt="anhsp">
      </div>
      <br>
    </div>
    <div class="thongtin">
      <h3>Hạt vị tổng hợp</h3>
      <span> Giá: 150.000 vnđ</span> <br>
      <span>Lượt Xem : 323</span> <i class="ri-eye-line"></i>
      <br>
      <!-- <input type="button" value="Thêm Vào Giỏ Hàng" onclick="addCart(this, 8, 'Hạt vị cá thu', 150000, 'image/thucan4.jpg', 1)">
