...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <form action="<?php echo e(route('roles.update', ['id' => $role->id])); ?>" method="post" enctype="multipart/form-data" class="col-md-12">
                    <div class="col-md-12">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <label for="">Name</label>
                            <input type="text" name="name" value="<?php echo e($role->name); ?>" class="form-control " placeholder="Enter name">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="display_name" class="form-control" id="" cols="30" rows="4"><?php echo e($role->display_name); ?></textarea>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="card bg-light mb-3 col-md-12">
                                ...
                                <!-- ABC.contains('id', 123) Kiểm tra cột ABC.id có mang giá trị 123 ko () -->
                                <div class="row">
                                    ...
                                    <div class="card-body col-md-3>
                                        ...
                                        <input type="checkbox" class="box-15px checkbox_childrent" <?php echo e($permissionsChecked->contains('id', $permissionsChildrentItem->id) ? 'checked' : ''); ?> name="permission_id[]" id="" value="<?php echo e($permissionsChildrentItem->id); ?>">
...
<!-- /.content-wrapper -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop\resources\views/admin/role/edit.blade.php ENDPATH**/ ?>