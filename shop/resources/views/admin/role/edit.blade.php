...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <form action="{{ route('roles.update', ['id' => $role->id]) }}" method="post" enctype="multipart/form-data" class="col-md-12">
                    <div class="col-md-12">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="display_name" class="form-control" id="" cols="30" rows="4">{{ $role->display_name }}</textarea>
                            @error('display_name')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="card bg-light mb-3 col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="card-body col-md-3>
                                        ...
                                        <input type="checkbox" class="box-15px checkbox_childrent" {{ $permissionsChecked->contains('id', $permissionsChildrentItem->id) ? 'checked' : ''}} name="permission_id[]" id="" value="{{ $permissionsChildrentItem->id }}">
